defmodule Phxblog.CommentController do
  ...
  plug :set_post_and_authorize_user when action in [:update, :delete]
    ...
    case Repo.insert(changeset) do
      ...
      {:error, changeset} ->
        render(conn, Phxblog.PostView, "show.html", post: post, user: post.user, comment_changeset: changeset)
    end
  end
  ...
  defp is_authorized_user?(conn) do
    ...
    (user && (user.id == post.user_id || Phxblog.RoleChecker.is_admin?(user)))
  end
end